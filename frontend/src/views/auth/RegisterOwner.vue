    ...
    <AuthLayout>
        <div class="space-y-6">
            ...
            <div class="text-center">
                <h2 class="text-3xl font-bold text-gray-900">Create Owner Account</h2>
                <p class="mt-2 text-sm text-gray-600">
                    Start your retail journey with RetailHub
                </p>
            </div>
            ...
            <form @submit.prevent="handleRegister" class="space-y-4">
                ...
                <Button type="submit" variant="primary" size="lg" full-width :loading="authStore.loading"
                    ...
                    {{ authStore.loading ? 'Creating Account...' : 'Create Owner Account' }}
                </Button>
            </form>

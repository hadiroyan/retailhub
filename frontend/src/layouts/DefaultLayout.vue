    ...
    <div class="min-h-screen flex flex-col bg-gray-50">
        ...
        <header class="bg-white border-b border-gray-200 h-16 flex items-center px-6 sticky top-0 z-50 shadow-sm">
            <div class="max-w-7xl mx-auto w-full flex items-center justify-between">
                ...
                <!-- Right: Auth buttons (Unauthenticated)-->
                ...
                <!-- Right: Auth buttons (Authenticated)-->
                <div v-else class="relative" ref="dropdownRef">
                    <button @click="toggleDropdown"
                        ...
                        <div class="h-9 w-9 hidden sm:flex rounded-full bg-gray-200 items-center justify-center">
